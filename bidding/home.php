...
<?php
$cid = (isset($_GET['category_id']) && $_GET['category_id'] != "all") ? $_GET['category_id'] : 0;
?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            // echo "SELECT * FROM products where unix_timestamp(bid_end_datetime) >= " . strtotime(date("Y-m-d H:i")) . " $where order by name asc";
                            // die;
                            if ($cat->num_rows <= 0) {
